...
Generated by the `ux-audit` skill on 2026-08-12 against commit `0e67682`. These plans live in `design-plans/` because the existing `plans/` directory is the engineering execution ledger and must not be mixed with UX handoffs.

 ...
 * process-wide SharedPreferences cache, and [dev.cockpit.app.ui.motion.rememberHaptic]
...
class AppearancePreferencesStore(context: Context) {
    ...
    /** Off silences every [dev.cockpit.app.ui.motion.HapticEvent], BEL and NeedsYou included. */
    var hapticsEnabled: Boolean
        get() = prefs.getBoolean(KEY_HAPTICS, DEFAULT_HAPTICS)
        set(value) = prefs.edit().putBoolean(KEY_HAPTICS, value).apply()

    companion object {
        const val FILE = "cockpit_appearance"

...
/**
 * One factory helper for the whole app: pulls [CockpitApp] from the
 * [CreationExtras] (the standard APPLICATION_KEY slot) so call sites never
 * cast `applicationContext as CockpitApp` themselves, and the eight

...
class NotificationReplyReceiverTest {
    ...
    private lateinit var originalBridgeProvider: (Context) -> dev.cockpit.app.net.CockpitApi
    ...
    fun setUp() {
        ...
        NotificationReplyReceiver.bridgeProvider = { ctx ->
            dev.cockpit.app.net.BridgeClient(
    ...
    private companion object {
        const val ACTION_REPLY = "dev.cockpit.TEST_REPLY"
    }
    ...
    fun reply_brokenBridgeLogsWarningInsteadOfSwallowing() {
        ...
        val logged = ShadowLog.getLogsForTag("CockpitReply")

...
|------|---------|----------|--------|
| Bridge typecheck+tests | `cd bridge && npm run typecheck && npm test` | 2026-08-12 (plans 001–003) | 275 tests / 43 suites, 0 fail, 0 skipped (live herdr socket ran); typecheck exit 0 |

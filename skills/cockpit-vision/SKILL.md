---
name: cockpit-vision
description: Inspect Cockpit screenshots, mockups, rendered UI, or diagrams when the active agent cannot directly use vision. Delegate through Herdr lifecycle state using the global herdr-agent-delegation skill.
---

# Cockpit vision workflow
